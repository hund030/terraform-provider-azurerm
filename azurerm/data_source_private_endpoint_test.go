		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(dataSourceName, "manual_private_link_service_connections.0.name", fmt.Sprintf("acctestconnection-%d", ri)),
					resource.TestCheckResourceAttrSet(dataSourceName, "manual_private_link_service_connections.0.private_link_service_id"),
				),
			},
		},
	})
